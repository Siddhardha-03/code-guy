 ...
 * @access  Private (Admin only)
 */
router.post('/:id/test-cases', verifyFirebaseToken, isAdmin, async (req, res) => {
  try {
    const questionId = req.params.id;
 ...
 * @access  Private (Admin only)
 */
router.get('/:id/all-test-cases', verifyFirebaseToken, isAdmin, async (req, res) => {
  try {
    const questionId = req.params.id;
 ...
 * @access  Private (Admin only)
 */
router.put('/:questionId/test-cases/:testCaseId/toggle-hidden', verifyFirebaseToken, isAdmin, async (req, res) => {
  try {
 ...
 * @access  Private (Admin only)
 */
router.get('/test-connection', verifyFirebaseToken, isAdmin, async (req, res) => {
  try {
 ...
 * @access  Private (Admin only)
 */
router.post('/test-update', verifyFirebaseToken, isAdmin, async (req, res) => {
  try {
 ...
 * @access  Private (Admin only)
 */
router.post('/:id/debug-test-cases', verifyFirebaseToken, isAdmin, async (req, res) => {
  try {
    const questionId = req.params.id;
    const { testCases } = req.body;
