...
const Quiz = ({ user }) => {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      {/* Filters */}
      <div className="bg-gray-50 bg-opacity-30 border border-blue-200 p-4 rounded-lg">
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-stretch">
            {quizzes.length > 0 ? (
              quizzes.map((quiz) => (
                <div key={quiz.id} className="bg-gray-50 bg-opacity-30 border border-blue-200 rounded-lg overflow-hidden hover:border-blue-400 transition-all">
                  <div className="p-6">
