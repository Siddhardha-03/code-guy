      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="px-6 sm:px-8 py-8 sm:py-10">
          <div className="text-center mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-2">Join CodiGloo</h2>
            <p className="text-gray-600 text-sm">Start your coding journey today</p>
          </div>
